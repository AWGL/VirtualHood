...
class test_virtualhood(unittest.TestCase):
    ...
    def test_add_extra_columns_NTC_report(self):
        ...
        self.assertEqual(add_extra_columns_NTC_report(get_variantReport_NTC("HN", path), get_variant_report("HN", path, "tester")).iloc[1,11],331.1184)
    ...
    def test_get_gaps_file(self):
        ...
        self.assertEqual(len(get_gaps_file("HN", path, "tester", coverage_value)),10)
    ...
    def test_add_columns_hotspots_coverage(self):
        ...
        self.assertEqual(add_columns_hotspots_coverage(get_hotspots_coverage_file("HN", path, "tester", coverage_value), get_NTC_hotspots_coverage_file("HN", path, coverage_value), path, "tester", "HN")[0].iloc[1,5], 6.211180124223603)
    ...
    def test_get_NTC_genescreen_coverage_file(self):
        ...
        self.assertEqual(len(get_NTC_genescreen_coverage_file("HN", path, coverage_value)),6)
    ...
    def test_add_columns_genescreen_coverage_file(self):
        ...
        self.assertEqual(add_columns_genescreen_coverage(get_genescreen_coverage_file("HN", path, "tester", coverage_value), get_NTC_genescreen_coverage_file("HN", path, coverage_value),4, path, "tester", "HN").iloc[4,4], 3) 
    ...
    def test_get_subpanel_coverage(self):
        ...
        self.assertEqual(len(get_subpanel_coverage("HN", path,"tester", coverage_value)),1)
