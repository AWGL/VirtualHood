...
class test_virtualhood(unittest.TestCase):
    ...
    def test_match_polys_and_artefacts(self):
        self.assertEqual(match_polys_and_artefacts((expand_variant_report(get_variant_report("Breast", path, "tester"), get_variantReport_NTC("Breast", path))), (add_extra_columns_NTC_report(get_variantReport_NTC("Breast", path) ,get_variant_report("Breast", path, "tester"))), artefacts_list).iloc[0,18],"")
        self.assertEqual(match_polys_and_artefacts((expand_variant_report(get_variant_report("Glioma", path, "tester"), get_variantReport_NTC("Glioma", path))), (add_extra_columns_NTC_report(get_variantReport_NTC("Glioma", path) ,get_variant_report("Glioma", path, "tester"))),artefacts_list).iloc[1,16],"NO")
        self.assertEqual(match_polys_and_artefacts((expand_variant_report(get_variant_report("Glioma", path, "tester"), get_variantReport_NTC("Glioma", path))), (add_extra_columns_NTC_report(get_variantReport_NTC("Glioma", path) ,get_variant_report("Glioma", path, "tester"))),artefacts_list).iloc[1,18],"")
        self.assertEqual(match_polys_and_artefacts((expand_variant_report(get_variant_report("HeadAndNeck", path, "tester"), get_variantReport_NTC("HeadAndNeck", path))), (add_extra_columns_NTC_report(get_variantReport_NTC("HeadAndNeck", path) ,get_variant_report("HeadAndNeck", path, "tester"))),artefacts_list).iloc[1,16],"NO")
        self.assertEqual(match_polys_and_artefacts((expand_variant_report(get_variant_report("HeadAndNeck", path, "tester"), get_variantReport_NTC("HeadAndNeck", path))), (add_extra_columns_NTC_report(get_variantReport_NTC("HeadAndNeck", path) ,get_variant_report("HeadAndNeck", path, "tester"))),artefacts_list).iloc[1,18],"")
        self.assertEqual(match_polys_and_artefacts((expand_variant_report(get_variant_report("Lung", path, "tester"), get_variantReport_NTC("Lung", path))), (add_extra_columns_NTC_report(get_variantReport_NTC("Lung", path) ,get_variant_report("Lung", path, "tester"))),artefacts_list).iloc[1,16],"YES")
        self.assertEqual(match_polys_and_artefacts((expand_variant_report(get_variant_report("Lung", path, "tester"), get_variantReport_NTC("Lung", path))), (add_extra_columns_NTC_report(get_variantReport_NTC("Lung", path) ,get_variant_report("Lung", path, "tester"))),artefacts_list).iloc[1,18],325.728)
        self.assertEqual(match_polys_and_artefacts((expand_variant_report(get_variant_report("Lung", path, "tester"), get_variantReport_NTC("Lung", path))), (add_extra_columns_NTC_report(get_variantReport_NTC("Lung", path) ,get_variant_report("Lung", path, "tester"))),artefacts_list).iloc[0,19],0.42280285035629456)
        self.assertEqual(match_polys_and_artefacts((expand_variant_report(get_variant_report("Melanoma", path, "tester"), get_variantReport_NTC("Melanoma", path))), (add_extra_columns_NTC_report(get_variantReport_NTC("Melanoma", path) ,get_variant_report("Melanoma", path, "tester"))),artefacts_list).iloc[0,16],"NO")
        self.assertEqual(match_polys_and_artefacts((expand_variant_report(get_variant_report("Melanoma", path, "tester"), get_variantReport_NTC("Melanoma", path))), (add_extra_columns_NTC_report(get_variantReport_NTC("Melanoma", path) ,get_variant_report("Melanoma", path, "tester"))),artefacts_list).iloc[0,18],"")
        self.assertEqual(match_polys_and_artefacts((expand_variant_report(get_variant_report("Ovarian", path, "tester"), get_variantReport_NTC("Ovarian", path))), (add_extra_columns_NTC_report(get_variantReport_NTC("Ovarian", path) ,get_variant_report("Ovarian", path, "tester"))),artefacts_list).iloc[1,18],"")
        self.assertEqual(match_polys_and_artefacts((expand_variant_report(get_variant_report("Prostate", path, "tester"), get_variantReport_NTC("Prostate", path))), (add_extra_columns_NTC_report(get_variantReport_NTC("Prostate", path) ,get_variant_report("Prostate", path, "tester"))),artefacts_list).iloc[0,16],"NO")
        self.assertEqual(match_polys_and_artefacts((expand_variant_report(get_variant_report("Prostate", path, "tester"), get_variantReport_NTC("Prostate", path))), (add_extra_columns_NTC_report(get_variantReport_NTC("Prostate", path) ,get_variant_report("Prostate", path, "tester"))),artefacts_list).iloc[0,18],"")
        self.assertEqual(match_polys_and_artefacts((expand_variant_report(get_variant_report("Thyroid", path, "tester"), get_variantReport_NTC("Thyroid", path))), (add_extra_columns_NTC_report(get_variantReport_NTC("Thyroid", path) ,get_variant_report("Thyroid", path, "tester"))),artefacts_list).iloc[6,16], "YES" )
        self.assertEqual(match_polys_and_artefacts((expand_variant_report(get_variant_report("Thyroid", path, "tester"), get_variantReport_NTC("Thyroid", path))), (add_extra_columns_NTC_report(get_variantReport_NTC("Thyroid", path) ,get_variant_report("Thyroid", path, "tester"))),artefacts_list).iloc[6,18], 21.675 )
        self.assertEqual(match_polys_and_artefacts((expand_variant_report(get_variant_report("Thyroid", path, "tester"), get_variantReport_NTC("Thyroid", path))), (add_extra_columns_NTC_report(get_variantReport_NTC("Thyroid", path) ,get_variant_report("Thyroid", path, "tester"))),artefacts_list).iloc[6,19],0.09980430528375735)
