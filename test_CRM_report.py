...
class test_virtualhood(unittest.TestCase):
    ...
    def test_add_extra_columns_NTC_report(self):
        ...
        self.assertEqual(ws7["F3"].value, "Genotype3")
        self.assertEqual(ws7["G3"].value, 7)
        self.assertEqual(ws7["H3"].value, "Quality3")
	...
	#TP53
        ...
        self.assertEqual(ws7["F3"].value, "Genotype4")
        self.assertEqual(ws7["G3"].value, 8)
        self.assertEqual(ws7["H3"].value, "Quality4")
        ...
        self.assertEqual(ws7["F4"].value, "Genotype5")
        self.assertEqual(ws7["G4"].value, 9)
        self.assertEqual(ws7["H4"].value, "Quality5")
	...
	#FOCUS4
        ...
        self.assertEqual(variant_report_FOCUS4.iloc[0,4], 1.0)
        self.assertEqual(variant_report_FOCUS4.iloc[0,5], "Genotype1")
        self.assertEqual(variant_report_FOCUS4.iloc[0,6], 7)
        self.assertEqual(variant_report_FOCUS4.iloc[0,7], "Quality1")
        ...
        self.assertEqual(variant_report_FOCUS4.iloc[1,5], "Genotype7")
        self.assertEqual(variant_report_FOCUS4.iloc[1,6], 11)
        self.assertEqual(variant_report_FOCUS4.iloc[1,7], "Quality7")
	...
	#TP53
        ...
        self.assertEqual(variant_report_TP53.iloc[0,5], "Genotype3")
        self.assertEqual(variant_report_TP53.iloc[0,6], 5)
        self.assertEqual(variant_report_TP53.iloc[0,7], "Quality3")
        self.assertEqual(variant_report_TP53.iloc[0,8], "Transcript3")
        self.assertEqual(variant_report_TP53.iloc[0,9], "variant3")
        self.assertEqual(variant_report_TP53.iloc[0,10], "")
        ...
        self.assertEqual(variant_report_TP53.iloc[1,5], "Genotype1")
        self.assertEqual(variant_report_TP53.iloc[1,6], 7)
        self.assertEqual(variant_report_TP53.iloc[1,7], "Quality1")
        ...
        self.assertEqual(variant_report_TP53.iloc[2,5], "Genotype7")
        self.assertEqual(variant_report_TP53.iloc[2,6], 11)
        self.assertEqual(variant_report_TP53.iloc[2,7], "Quality7")
	...
	#FOCUS4
        ...
        self.assertEqual(ws2["R10"].value, '7.0')
        self.assertEqual(ws2["S10"].value, 5.0)
        self.assertEqual(ws2["T10"].value, 0.7142857142857143 )
        ...
        self.assertEqual(ws2["F11"].value, "Genotype7")
        self.assertEqual(ws2["G11"].value, 11.0)
        self.assertEqual(ws2["H11"].value, "Quality7")
	...
	#TP53
        ...
        self.assertEqual(ws2["F11"].value, "Genotype1")
        self.assertEqual(ws2["G11"].value, 7)
        self.assertEqual(ws2["H11"].value, "Quality1")
        ...
        self.assertEqual(ws2["S11"].value, 5.0)
        self.assertEqual(ws2["T11"].value, 0.7142857142857143  )
        self.assertEqual(ws2["U11"].value, '')
        self.assertEqual(ws2["V11"].value, '' )
        self.assertEqual(ws2["W11"].value, None)
        ...
        self.assertEqual(ws2["F12"].value, "Genotype7")
        self.assertEqual(ws2["G12"].value, 11)
        self.assertEqual(ws2["H12"].value, "Quality7")
